---
title: 文档指引架构，而不是文档反映架构：我在 NeoCode 中学到的工程经验
summary: 从 NeoCode 第二阶段总结出发，记录我对 AI 编程、文档先行、架构减法和功能乘法的理解：代码生成越来越容易，但系统边界、主流程、非目标和验收标准必须先被写清楚。
...
我现在更愿意把架构文档理解成一种“实现前的约束”。

它不是代码写完后的说明书，而是系统开始生长前的边界定义。
...
> 架构做减法，不是功能少做，而是先挡住不该进入当前阶段的复杂度。
...
如果让我现在重新写一个架构设计 Issue 或文档，我会尽量按这个结构来：
...
这也是我在 NeoCode 里最重要的工程经验之一。

## 还是那句话：AI 可以生成代码，但人必须先写清楚边界
...
这也是我从 NeoCode 第二阶段开始，一直到后来的 Gateway、Hooks、SubAgent、Skills、ToolManager、Verification 和 HITL 中不断学到的事。
